...
$(document).ready(function(){
   ...
   $('.featured-item:first h4').append('<span class="badge bg-secondary">Top</span>')
   ...
   $('body').on('submit', '.modal-body .form', function(e){
      ...
      if(inputEmail.hasClass('invalid') || inputName.hasClass('invalid')){
         ...
         console.log('Formulário inserido')
         $(this).on()
         $('form')[0].reset()
         $('.modal').modal('hide'); 
         $('html,body').scrollTop(0);
         // $('html,body').activeTab(reset('./index.html'))
         // $('html,body').index();
      }
   ...
   $('body').on('blur', '#mensagem', function(){
      validate($(this))
      $(this).text();
   })
